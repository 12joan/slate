...
describe.skip('decorations', () => {
  ...
  describe('redecorating', () => {
    ...
    it('redecorates undecorated nodes when they change', async () => {
      const editor = withReact(createEditor())
      const initialValue = [{ children: [{ text: 'The quick brown fox' }] }]
    ...
    it('redecorates decorated nodes when they change', async () => {
      const editor = withReact(createEditor())
      const initialValue = [{ children: [{ text: 'The quick brown box' }] }]
    ...
    // Not supported by slate-react due to element memoization
    it.skip('redecorates nodes when their paths change', async () => {
      const editor = withReact(createEditor())
